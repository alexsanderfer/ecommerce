...
<table cellspacing=0 cellpadding=0 width=666 border=0>
    <TBODY>
    <TR>
        <TD class=ct width=666><img height=1 src=/custom/boletophp/imagens//6.png width=665 border=0></TD>
    </TR>
    <TR>
...
<table width=666 cellspacing=5 cellpadding=0 border=0 align=Default>
    <tr>
        <td width=41><IMG SRC="/custom/site/img/logo.png"></td>
        <td class=ti
            width=455><?php echo $dadosboleto["identificacao"]; ?> <?php echo isset($dadosboleto["cpf_cnpj"]) ? "<br>" . $dadosboleto["cpf_cnpj"] : '' ?>
            <br>
...
<table cellspacing=0 cellpadding=0 width=666 border=0>
  ...
  <span class="campo"><IMG
              src="/custom/boletophp/imagens/logoitau.jpg" width="150" height="40"
              border=0></span></td>
        <td width=3 valign=bottom><img height=22 src=/custom/boletophp/imagens//3.png width=2 border=0></td>
...
<?php echo $dadosboleto["linha_digitavel"] ?>
    ...
    <tbody>
    <tr>
        <td colspan=5><img height=2 src=/custom/boletophp/imagens//2.png width=666 border=0></td>
    </tr>
    </tbody>
</table>
<table cellspacing=0 cellpadding=0 border=0>
    <tbody>
    <tr>
        <td class=ct valign=top width=7 height=13><img height=13 src=/custom/boletophp/imagens//1.png width=1 border=0>
        </td>
    ...
    <tr>
        <td class=cp valign=top width=7 height=12><img height=12 src=/custom/boletophp/imagens//1.png width=1 border=0>
        </td>
  ...
  <?php echo $dadosboleto["nosso_numero"] ?>
    ...
    <tr>
        <td valign=top width=7 height=1><img height=1 src=/custom/boletophp/imagens//2.png width=7 border=0></td>
        <td valign=top width=298 height=1><img height=1 src=/custom/boletophp/imagens//2.png width=298 border=0></td>
        <td valign=top width=7 height=1><img height=1 src=/custom/boletophp/imagens//2.png width=7 border=0></td>
        <td valign=top width=126 height=1><img height=1 src=/custom/boletophp/imagens//2.png width=126 border=0></td>
        <td valign=top width=7 height=1><img height=1 src=/custom/boletophp/imagens//2.png width=7 border=0></td>
        <td valign=top width=34 height=1><img height=1 src=/custom/boletophp/imagens//2.png width=34 border=0></td>
        <td valign=top width=7 height=1><img height=1 src=/custom/boletophp/imagens//2.png width=7 border=0></td>
        <td valign=top width=53 height=1><img height=1 src=/custom/boletophp/imagens//2.png width=53 border=0></td>
        <td valign=top width=7 height=1><img height=1 src=/custom/boletophp/imagens//2.png width=7 border=0></td>
        <td valign=top width=120 height=1><img height=1 src=/custom/boletophp/imagens//2.png width=120 border=0></td>
    </tr>
    </tbody>
</table>
<table cellspacing=0 cellpadding=0 border=0>
  ...
  <?php echo $dadosboleto["valor_boleto"] ?>
    ...
    <tr>
        <td valign=top width=7 height=1><img height=1 src=/custom/boletophp/imagens//2.png width=7 border=0></td>
        <td valign=top width=113 height=1><img height=1 src=/custom/boletophp/imagens//2.png width=113 border=0></td>
        <td valign=top width=7 height=1><img height=1 src=/custom/boletophp/imagens//2.png width=7 border=0></td>
        <td valign=top width=72 height=1><img height=1 src=/custom/boletophp/imagens//2.png width=72 border=0></td>
        <td valign=top width=7 height=1><img height=1 src=/custom/boletophp/imagens//2.png width=7 border=0></td>
        <td valign=top width=132 height=1><img height=1 src=/custom/boletophp/imagens//2.png width=132 border=0></td>
        <td valign=top width=7 height=1><img height=1 src=/custom/boletophp/imagens//2.png width=7 border=0></td>
        <td valign=top width=134 height=1><img height=1 src=/custom/boletophp/imagens//2.png width=134 border=0></td>
        <td valign=top width=7 height=1><img height=1 src=/custom/boletophp/imagens//2.png width=7 border=0></td>
        <td valign=top width=180 height=1><img height=1 src=/custom/boletophp/imagens//2.png width=180 border=0></td>
    </tr>
    </tbody>
</table>
<table cellspacing=0 cellpadding=0 border=0>
    ...
    <tr>
        ...
        <td class=ct valign=top width=7 height=13><img height=13 src=/customcustom/boletophp/imagens//1.png width=1
                                                       border=0></td>
        <td class=ct valign=top width=112 height=13>(-)
            Outras deduções
        </td>
        <td class=ct valign=top width=7 height=13><img height=13 src=/customres/boletophp/imagens//1.png width=1
                                                       border=0></td>
        <td class=ct valign=top width=113 height=13>(+)
            Mora / Multa
        </td>
    ...
    <tr>
        <td class=cp valign=top width=7 height=12><img height=12 src=/customres/boletophp/imagens//1.png width=1
                                                       border=0></td>
    ...
    <tr>
        ...
        <td valign=top width=113 height=1><img height=1 src=/custom/boletophp/imagens//2.png width=113 border=0></td>
        <td valign=top width=7 height=1><img height=1 src=/custom/boletophp/imagens//2.png width=7 border=0></td>
        <td valign=top width=112 height=1><img height=1 src=/custom/boletophp/imagens//2.png width=112 border=0></td>
        <td valign=top width=7 height=1><img height=1 src=/custom/boletophp/imagens//2.png width=7 border=0></td>
        <td valign=top width=113 height=1><img height=1 src=/custom/boletophp/imagens//2.png width=113 border=0></td>
        <td valign=top width=7 height=1><img height=1 src=/custom/boletophp/imagens//2.png width=7 border=0></td>
        <td valign=top width=113 height=1><img height=1 src=/custom/boletophp/imagens//2.png width=113 border=0></td>
...
<table cellspacing=0 cellpadding=0 border=0>
  ...
  <?php echo $dadosboleto["sacado"] ?>
    ...
    <tr>
        <td valign=top width=7 height=1><img height=1 src=/custom/boletophp/imagens//2.png width=7 border=0></td>
        <td valign=top width=659 height=1><img height=1 src=/custom/boletophp/imagens//2.png width=659 border=0></td>
    </tr>
    </tbody>
</table>
<table cellspacing=0 cellpadding=0 border=0>
...
<table cellspacing=0 cellpadding=0 border=0>
  ...
  <?php echo $dadosboleto["data_vencimento"] ?>
    ...
    <tr>
        <td valign=top width=7 height=1><img height=1 src=/custom/boletophp/imagens//2.png width=7 border=0></td>
        <td valign=top width=472 height=1><img height=1 src=/custom/boletophp/imagens//2.png width=472 border=0></td>
        <td valign=top width=7 height=1><img height=1 src=/custom/boletophp/imagens//2.png width=7 border=0></td>
        <td valign=top width=180 height=1><img height=1 src=/custom/boletophp/imagens//2.png width=180 border=0></td>
    </tr>
    </tbody>
...
<table cellspacing=0 cellpadding=0 border=0>
    ...
    <tr>
        <td class=ct valign=top width=7 height=13>
            <img height=13 src=/custom/boletophp/imagens//1.png width=1 border=0></td>
   ...
   <?php echo $dadosboleto["data_processamento"] ?>
    ...
    <tr>
        ...
        <td valign=top width=7 height=1>
            <img height=1 src=/custom/boletophp/imagens//2.png width=7 border=0></td>
        <td valign=top width=153 height=1><img height=1 src=/custom/boletophp/imagens//2.png width=153 border=0></td>
        <td valign=top width=7 height=1>
            <img height=1 src=/custom/boletophp/imagens//2.png width=7 border=0></td>
        <td valign=top width=62 height=1><img height=1 src=/custom/boletophp/imagens//2.png width=62 border=0></td>
        <td valign=top width=7 height=1>
            <img height=1 src=/custom/boletophp/imagens//2.png width=7 border=0></td>
        <td valign=top width=34 height=1><img height=1 src=/custom/boletophp/imagens//2.png width=34 border=0></td>
        <td valign=top width=7 height=1>
            <img height=1 src=/custom/boletophp/imagens//2.png width=7 border=0></td>
        <td valign=top width=82 height=1><img height=1 src=/custom/boletophp/imagens//2.png width=82 border=0></td>
        <td valign=top width=7 height=1>
            <img height=1 src=/custom/boletophp/imagens//2.png width=7 border=0></td>
        <td valign=top width=180 height=1>
            <img height=1 src=/custom/boletophp/imagens//2.png width=180 border=0></td>
    </tr>
    </tbody>
</table>
<table cellspacing=0 cellpadding=0 border=0>
    ...
    <tr>
        ...
        <td class=ct valign=top height=13 width=7><img height=13 src=/custom/boletophp/imagens//1.png width=1 border=0>
        </td>
...
<?php echo $dadosboleto["especie"] ?>
 ...
 <?php echo $dadosboleto["quantidade"] ?>
   ...
   <?php echo $dadosboleto["valor_boleto"] ?>
    ...
    <tr>
        <td valign=top width=7 height=1><img height=1 src=/custom/boletophp/imagens//2.png width=7 border=0></td>
        <td valign=top width=7 height=1><img height=1 src=/custom/boletophp/imagens//2.png width=75 border=0></td>
        <td valign=top width=7 height=1><img height=1 src=/custom/boletophp/imagens//2.png width=7 border=0></td>
        <td valign=top width=31 height=1><img height=1 src=/custom/boletophp/imagens//2.png width=31 border=0></td>
        <td valign=top width=7 height=1>
            <img height=1 src=/custom/boletophp/imagens//2.png width=7 border=0></td>
        <td valign=top width=83 height=1><img height=1 src=/custom/boletophp/imagens//2.png width=83 border=0></td>
        <td valign=top width=7 height=1>
            <img height=1 src=/custom/boletophp/imagens//2.png width=7 border=0></td>
        <td valign=top width=53 height=1><img height=1 src=/custom/boletophp/imagens//2.png width=53 border=0></td>
        <td valign=top width=7 height=1>
            <img height=1 src=/custom/boletophp/imagens//2.png width=7 border=0></td>
        <td valign=top width=123 height=1><img height=1 src=/custom/boletophp/imagens//2.png width=123 border=0></td>
        <td valign=top width=7 height=1>
            <img height=1 src=/custom/boletophp/imagens//2.png width=7 border=0></td>
        <td valign=top width=72 height=1><img height=1 src=/custom/boletophp/imagens//2.png width=72 border=0></td>
        <td valign=top width=7 height=1>
    ...
    <tr>
        <td align=right width=10>
            <table cellspacing=0 cellpadding=0 border=0 align=left>
                <tbody>
                <tr>
                    <td class=ct valign=top width=7 height=13><img height=13 src=/custom/boletophp/imagens//1.png
                                                                   width=1 border=0></td>
                </tr>
                <tr>
                    <td class=cp valign=top width=7 height=12><img height=12 src=/custom/boletophp/imagens//1.png
                                                                   width=1 border=0></td>
                </tr>
                <tr>
                    <td valign=top width=7 height=1><img height=1 src=/custom/boletophp/imagens//2.png width=1 border=0>
                    </td>
                </tr>
                </tbody>
            </table>
...
<?php echo $dadosboleto["instrucoes4"]; ?></FONT><br><br>
        ...
        <td align=right width=188>
            <table cellspacing=0 cellpadding=0 border=0>
                ...
                <tr>
                    <td valign=top width=7 height=1><img height=1 src=/custom/boletophp/imagens//2.png width=7 border=0>
                    </td>
                    <td valign=top width=180 height=1><img height=1 src=/custom/boletophp/imagens//2.png width=180
                                                           border=0></td>
                </tr>
                </tbody>
            </table>
    ...
    <tr>
        <td align=right width=10>
            <table cellspacing=0 cellpadding=0 border=0 align=left>
                ...
                <tr>
                    <td valign=top width=7 height=1>
                        <img height=1 src=/custom/boletophp/imagens//2.png width=1 border=0></td>
                </tr>
                </tbody>
            </table>
        </td>
...
<table cellspacing=0 cellpadding=0 width=666 border=0>
    <tbody>
    <tr>
        <td valign=top width=666 height=1><img height=1 src=/custom/boletophp/imagens//2.png width=666 border=0></td>
    </tr>
    </tbody>
</table>
<table cellspacing=0 cellpadding=0 border=0>
