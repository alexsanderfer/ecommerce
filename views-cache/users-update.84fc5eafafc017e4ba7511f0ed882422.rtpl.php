        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <!-- form start -->
                    <form role="form"
                          action="<?php echo htmlspecialchars($dir_url, ENT_COMPAT, 'UTF-8', FALSE); ?>/admin/users/<?php echo htmlspecialchars($user["iduser"], ENT_COMPAT, 'UTF-8', FALSE); ?>"
                          method="post">
                        <div class="box-body">
                            ...
                            <div class="checkbox">
                                <label>
                                    <input type="checkbox" name="inadmin" value="1"
                                           <?php if ($user["inadmin"] == 1){ ?>checked<?php } ?>> Acesso de
                                    Administrador
                                </label>
                            </div>
                        </div>
