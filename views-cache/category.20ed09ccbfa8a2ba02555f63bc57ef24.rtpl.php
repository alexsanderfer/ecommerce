                    ...
                    <div class="col-lg-4 col-sm-6 mb-5">
                        <div class="product-item">
                            <div class="pi-pic">
                                ...
                                <div class="pi-links">
                                    <a class="add-card" href="/cart/<?php echo htmlspecialchars( $value1["idproduct"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/add"><i class="flaticon-bag"></i><span>ADD TO CART</span></a>
                                    <a class="wishlist-btn" href="#"><i class="flaticon-heart"></i></a>
                                </div>
                            </div>
                            <div class="pi-text">
                                <h6>R$<?php echo formatPrice($value1["vlprice"]); ?></h6>
                                <p class="texto-categoria"><a href="/products/<?php echo htmlspecialchars( $value1["desurl"], ENT_COMPAT, 'UTF-8', FALSE ); ?>"><?php echo htmlspecialchars( $value1["desproduct"], ENT_COMPAT, 'UTF-8', FALSE ); ?></a>
                                </p>
                            </div>
                        </div>
