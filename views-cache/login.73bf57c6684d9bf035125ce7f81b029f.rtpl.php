...
<div class="login-box">
  <div class="login-logo">
    <a href="../../index2.html"><b>Administração</b>Loja</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    ...
    <div class="social-auth-links text-center">
      <p>- OU -</p>
      <a href="#" class="btn btn-block btn-social btn-facebook btn-flat"><i class="fa fa-facebook"></i> Faça login usando o
        Facebook</a>
      <a href="#" class="btn btn-block btn-social btn-google btn-flat"><i class="fa fa-google-plus"></i> Faça login usando o
        Google</a>
    </div>
    <!-- /.social-auth-links -->
