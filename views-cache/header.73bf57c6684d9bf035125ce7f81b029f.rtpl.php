...
<head>
    ...
    <title>AdminLoja | Dashboard</title>
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li class="active"><a href="<?php echo htmlspecialchars( $dir_url, ENT_COMPAT, 'UTF-8', FALSE ); ?>/admin/users"><i class="fa fa-users"></i> <span>Usuários</span></a></li>
