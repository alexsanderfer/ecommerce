                        ...
                        <table class="body-text">
                          ...
                          <div><!--[if mso]>
                              <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml"
                                           ...
                                           style="height:38px;v-text-anchor:middle;width:230px;" arcsize="11%"
                                           strokecolor="#407429" fill="t">
                                  <v:fill type="tile" src="https://www.filepicker.io/api/file/N8GiNGsmT6mK6ORk00S7"
                                          color="#41CC00"/>
                                  <w:anchorlock/>
